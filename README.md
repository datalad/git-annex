...
[Releases](https://github.com/con/git-annex/releases) page.  All build logs
...
- [`upstream/master`](https://github.com/con/git-annex/tree/upstream/master) -
...
- [`master`](https://github.com/con/git-annex/tree/master) -
...
Description: <one-line summary>
 <if needed - longer explanation: why this patch exists in con/git-annex,
 what it works around, and who benefits>
Origin: vendor, https://github.com/con/git-annex/commit/<sha>
...
[![Update mirror](https://github.com/con/git-annex/actions/workflows/update-mirror.yml/badge.svg)](https://github.com/con/git-annex/actions/workflows/update-mirror.yml)

### Build git-annex & test DataLad against it

[![Ubuntu](https://github.com/con/git-annex/actions/workflows/build-ubuntu.yaml/badge.svg)](https://github.com/con/git-annex/actions/workflows/build-ubuntu.yaml)
[![macOS](https://github.com/con/git-annex/actions/workflows/build-macos.yaml/badge.svg)](https://github.com/con/git-annex/actions/workflows/build-macos.yaml)
[![Windows](https://github.com/con/git-annex/actions/workflows/build-windows.yaml/badge.svg)](https://github.com/con/git-annex/actions/workflows/build-windows.yaml)

### Client Tests

| Client | Test Status |
| --- | --- |
| [openmind7](https://con.github.io/git-annex-ci-reports/#openmind7) | ![Overall test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/openmind7.svg) ![git-annex-home test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/openmind7/git-annex-home.svg) ![git-annex-om2 test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/openmind7/git-annex-om2.svg) |
| [ndoli](https://con.github.io/git-annex-ci-reports/#ndoli) | ![Overall test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/ndoli.svg) ![git-annex-home test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/ndoli/git-annex-home.svg) ![git-annex-tmp test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/ndoli/git-annex-tmp.svg) |
| [smaug](https://con.github.io/git-annex-ci-reports/#smaug) | ![Overall test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/smaug.svg) ![git-annex test status](https://github.com/con/git-annex-ci-client-jobs/raw/master/badges/smaug/git-annex.svg) |
